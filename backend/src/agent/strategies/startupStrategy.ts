...
const stage1_launchEventOverview: StageDefinition = {
  ...
  tasks: [
    ...
    },
    {
      ...
      priority: 3,
      executionMode: 'direct_skill',
      directSkillId: 'io_pressure',
      paramMapping: {
        package: 'processName',
        start_ts: 'startTs',
        end_ts: 'endTs',
      },
      descriptionTemplate: '启动区间系统补充：{{scopeLabel}}（IO 压力）',
    },
    {
      agentId: 'system_agent',
      domain: 'network',
      ...
      priority: 4,
      executionMode: 'direct_skill',
      directSkillId: 'network_analysis',
      paramMapping: {
        package: 'processName',
        start_ts: 'startTs',
        end_ts: 'endTs',
      },
      descriptionTemplate: '启动区间系统补充：{{scopeLabel}}（网络活动）',
    },
    {
      agentId: 'system_agent',
      domain: 'thermal',
      ...
      priority: 5,
      executionMode: 'direct_skill',
      directSkillId: 'thermal_throttling',
      paramMapping: {
        package: 'processName',
        start_ts: 'startTs',
        end_ts: 'endTs',
      ...
      descriptionTemplate: '启动区间系统补充：{{scopeLabel}}（热节流）',
    },
  ],
  extractIntervals: extractStartupIntervals,
  shouldStop: (intervals) => {
